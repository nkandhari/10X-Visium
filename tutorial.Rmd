---
title: "10x Visium: Analysis, visualization, and integration of spatial datasets with Seurat"
output:
  html_document:
    theme: united
    df_print: kable
...
This content is the Seurat [Spatial tutorial](https://satijalab.org/seurat/articles/spatial_vignette.html) with additional challenges.
...
jpeg(filename = "output/spatial_vignette_ttr.jpg", height = 700, width = 1200, quality = 50)
print(plot)
dev.off()
```
